...
The Teamscale plugin exposes the following MCP resources and resource templates (auto-generated from the Teamscale OpenAPI spec). Resources are read-only GET endpoints; resource templates require path parameters.
