# Teamscale Custom Plugin for Claude Code (Python)
...
A [TypeScript implementation](../teamscale-typescript-custom/) with identical tools is also available. Choose whichever language fits your environment.
